...
//    public ResponseEntity<CropResponse> handleBadRequestException(BadRequestException ex) {
//        CropResponse response = new CropResponse("Invalid request: " + ex.getMessage(), null);
//        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
//    }
//
//    @ExceptionHandler(Exception.class)
//    public ResponseEntity<CropResponse> handleGenericException(Exception ex) {
//        CropResponse response = new CropResponse("An unexpected error occurred: " + ex.getMessage(), null);
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BadRequestException.class)
    public ResponseEntity<CropResponse> handleBadRequestException(BadRequestException e) {
        CropResponse response = new CropResponse("Invalid request: " + e.getMessage(), null);
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
